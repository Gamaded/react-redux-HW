...
/*#__PURE__*/
exports.ReactReduxContext = _react2.default.createContext(null);
...
var _objectWithoutPropertiesLoose2 = __webpack_require__(4);
...
var _reactIs = __webpack_require__(9);

var _Subscription = __webpack_require__(2);

var _Subscription2 = _interopRequireDefault(_Subscription);

var _useIsomorphicLayoutEffect = __webpack_require__(10);
    ...
    function ConnectFunction(props) {
      var _useMemo = (0, _react.useMemo)(function () {
        ...
        var reactReduxForwardedRef = props.reactReduxForwardedRef,
            wrapperProps = (0, _objectWithoutPropertiesLoose3.default)(props, ["reactReduxForwardedRef"]);
...
var _verifyPlainObject = __webpack_require__(14);
...
var _useReduxContext2 = __webpack_require__(17);
...
var savedComments = localStorage.getItem('commentsStorage');
...
_reactDom2.default.render(_react2.default.createElement(_Comms2.default, { store: store }), document.querySelector('.main'));
...
var aa = __webpack_require__(0),
    ...
    r = __webpack_require__(21);function u(a) {
  for (var b = "https://reactjs.org/docs/error-decoder.html?invariant=" + a, c = 1; c < arguments.length; c++) {
    b += "&args[]=" + encodeURIComponent(arguments[c]);
  }return "Minified React error #" + a + "; visit " + b + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings.";
...
var _MakeComment = __webpack_require__(46);

var _MakeComment2 = _interopRequireDefault(_MakeComment);

var _AddComment = __webpack_require__(48);
...
var Comms = function Comms(props) {
	var comments = props.comments,
	    addComment = props.addComment,
	    deleteComment = props.deleteComment;


	var jason = JSON.stringify(comments);
	localStorage.setItem('commentsStorage', jason);

	return _react2.default.createElement(
		'section',
		null,
		_react2.default.createElement(_AddComment2.default, { comments: comments, deleteComment: deleteComment }),
		_react2.default.createElement(_MakeComment2.default, { addComment: addComment })
	);
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		addComment: function addComment(name, text, date) {
			return dispatch((0, _index.addComment)(name, text, date));
		},
		deleteComment: function deleteComment(id) {
			return dispatch((0, _index.deleteComment)(id));
		}
	};
};

Comms = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Comms);
...
var _useDispatch = __webpack_require__(43);

var _useSelector = __webpack_require__(44);

var _useStore = __webpack_require__(16);

var _batch = __webpack_require__(7);

var _reactBatchedUpdates = __webpack_require__(45);
...
var _mapStateToProps = __webpack_require__(39);

var _mapStateToProps2 = _interopRequireDefault(_mapStateToProps);

var _mergeProps = __webpack_require__(40);

var _mergeProps2 = _interopRequireDefault(_mergeProps);

var _selectorFactory = __webpack_require__(41);
...
var _wrapMapToProps = __webpack_require__(13);
...
var _verifySubselectors = __webpack_require__(42);
...
var MakeComment = function MakeComment(props) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', {
						...
						onChange: function onChange(ev) {
							_this2.name = ev.target.value;
						} }),
					_react2.default.createElement('textarea', {
						className: 'new-com-cont__text',
						placeholder: '\u0422\u0435\u043A\u0441\u0442 \u043A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u044F',
						onChange: function onChange(ev) {
							_this2.text = ev.target.value;
						} }),
					_react2.default.createElement(
						'button',
						{
							...
							onClick: function onClick() {
								if (_this2.name.trim() === '' || _this2.text.trim === '') {
									alert('Введите своё имя и текст комментария, пожалуйста');
									return;
								} else {
									addComment(_this2.name.trim(), _this2.text.trim(), _this2.date);
									_this2.name = '';
									_this2.text = '';
								}
							}
	...
	return _react2.default.createElement(Data, null);
};
...
var addComment = exports.addComment = function addComment(name, text, date) {
	return {
		type: 'ADD_COMMENT',
		id: nextComm++,
		name: name,
